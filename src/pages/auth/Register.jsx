                    ...
                    <div className="w-full max-w-xs">
                       <form className="flex flex-col gap-6" onSubmit={handleRegister}>
                            ...
                            <div className="grid gap-3">
                                ...
                                <Input id="text" onChange={e => setFormData({ ...formData, username: e.target.value })} type="text" placeholder="Enter a username"  />
                            </div>
                            <div className="grid gap-3">
                                <Label htmlFor="email">Email:</Label>
                                <Input id="text" onChange={e => setFormData({ ...formData, email: e.target.value })} type="email" placeholder="Enter your email"  />
                            </div>
                            <div className="grid gap-3">
                            ...
                            <p className="text-sm text-right">Already have an account? <Link to={'/Login'} className="underline font-bold">Login</Link></p>
