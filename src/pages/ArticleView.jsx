...
export default function ArticleView(){
    ...
    const [comment, setComment] = useState({
     ...
     const getPostLikes = async () => {
       try {
         const res = await fetch(
           `http://localhost:8080/blog/post/likes/${id}`,
           {
     ...
     const handleLikePost = async (e) => {
       e.preventDefault();
       const res = await fetch(
         `http://localhost:8080/blog/like/${id}`,
         {
           method: "POST",
           headers: {
...
const handleBookMarkPost = async (e) => {
  e.preventDefault();
  const res = await fetch(
    `http://localhost:8080/blog/bookmark/${id}`,
    {
      method: "post",
      headers: {
        Authorization: `Bearer ${token}`,
      ...
      <div className="">
        ...
        <div className={"max-w-4xl px-6 lg:px-0 mx-auto pt-[120px]"}>
          <div className={"mt-4"}>
            ...
            <h1
              className={
                "text-3xl my-4 font-bold font-montserrat text-slate-800"
              }
            >
              ...
              <div className="flex items-center gap-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-black">
                    Full Stack developer | Tech Enthusiast | Developer Advocate
                  </p>
                </div>
              </div>
                ...
                <span>
                  <Sheet>
                    <SheetTrigger className="flex items-center gap-x-1 cursor-pointer">
                      ...
                      <span>
                        {article ? article.commentsCount : ""} comments
                      </span>
                    </SheetTrigger>
                    <SheetContent>
                          ...
                          <div className="flex items-center gap-x-2">
                            ...
                            <div>
                              <h1 className="text-sm font-bold font-montserrat flex flex-col">
                               ...
                               <span className="text-blue-500 text-xs font-normal -mt-1">@{user && user.username}</span>
                              </h1>
                            </div>
                          </div>
