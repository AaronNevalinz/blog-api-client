    ...
    return (
        <div className="">
            ...
            <main className="max-w-2xl mx-auto">
                <div className="w-full overflow-x-auto whitespace-nowrap border-t border-gray-200 no-scrollbar">
                    <div className="mt-4 flex gap-x-3">
                        {
                        [1,2,3,4,5,6,7,8,9,0].map((tag)=><p className="capitalize cursor-pointer bg-slate-100 px-4 rounded-full">tags</p>)
                        }
                    </div>
                </div>
                <div>
